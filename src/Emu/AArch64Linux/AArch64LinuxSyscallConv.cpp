...
AArch64LinuxSyscallConv::AArch64LinuxSyscallConv(ProcessState* processState) : Linux64SyscallConv(processState)
{
}

AArch64LinuxSyscallConv::~AArch64LinuxSyscallConv()
{
}
...
void AArch64LinuxSyscallConv::Execute(OpEmulationState* opState)
{
#ifdef SYSCALL_DEBUG 
...
namespace {
	const int ARM_CLK_TCK = 100;

	const int ARM_MREMAP_MAYMOVE = 1;
	const int ARM_MAP_NORESERVE = 0x00040;
	const int ARM_MAP_ANONYMOUS = 0x20;
}

int AArch64LinuxSyscallConv::Get_MAP_ANONYMOUS()
{
	return ARM_MAP_ANONYMOUS;
}

int AArch64LinuxSyscallConv::Get_MREMAP_MAYMOVE()
{
	return ARM_MREMAP_MAYMOVE;
}

int AArch64LinuxSyscallConv::Get_CLK_TCK()
{
	return ARM_CLK_TCK;
}

u32 AArch64LinuxSyscallConv::OpenFlagTargetToHost(u32 flag)
{
